...
CSV_PATH = Path(r"delay_average_latency\delay_overall_avg_aligned.csv")

OUT_IMAGE = Path(r"delay_average_latency\delay_avg_latency_bar_chart.png")
OUT_SUMMARY = Path(r"delay_average_latency\delay_avg_latency_summary_bar.csv")

TITLE = "Întârziere medie (delay)"
Y_LABEL = "Întârzierea medie (ms)"
