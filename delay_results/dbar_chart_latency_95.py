...
CSV_PATH = Path(r"delay_p95_graphs\delay_latency_avg_aligned.csv")

OUT_IMAGE = Path(r"delay_p95_graphs\delay_p95_latency_bar_chart.png")
OUT_SUMMARY = Path(r"delay_p95_graphs\delay_p95_latency_summary_bar.csv")

TITLE = "Întârziere P95 (delay)"
Y_LABEL = "Întârzierea medie P95 (ms)"
