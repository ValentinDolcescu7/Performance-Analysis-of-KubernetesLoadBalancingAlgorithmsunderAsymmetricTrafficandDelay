...
# -*- coding: utf-8 -*-
"""
Grafic compact, o singura figura, citind overall_avg_aligned.csv.
...
DATA_DIR = "delay_average_latency"
CSV_PATH = os.path.join(DATA_DIR, "delay_overall_avg_aligned.csv")
OUT_PATH = os.path.join(DATA_DIR, "delay_avg_symlog.png")

TITLE     = "Întârziere medie (delay)"
YLABEL    = "Întârziere (ms)"
