...
DATA_DIR = "delay_p95_graphs"
CSV_PATH = os.path.join(DATA_DIR, "delay_latency_avg_aligned.csv")
OUT_PATH = os.path.join(DATA_DIR, "delay_latency_symlog.png")

TITLE     = "Întârziere P95 (delay)"
YLABEL    = "Întârziere P95 (ms)"
