...
DATA_DIR = Path(r"delay_processing_reqs_by_pod")
ALGORITHM_ORDER = ["RR", "WRR", "LC", "SED", "NQ"]

OUT_DIR = DATA_DIR / "results"
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUT_LONG_CSV = OUT_DIR / "delay_total_requests_by_pod_long.csv"
OUT_WIDE_COUNT_CSV = OUT_DIR / "delay_total_requests_by_pod_wide_count_raw.csv"
OUT_WIDE_NORMALIZED_CSV = OUT_DIR / "delay_total_requests_by_pod_wide_count_normalized.csv"
OUT_WIDE_PERCENT_CSV = OUT_DIR / "delay_total_requests_by_pod_wide_percent.csv"

OUT_CHART_COUNT_RAW = OUT_DIR / "delay_total_requests_by_pod_raw_count.png"
OUT_CHART_COUNT_NORMALIZED = OUT_DIR / "delay_total_requests_by_pod_normalized_count.png"
OUT_CHART_PERCENT = OUT_DIR / "delay_total_requests_by_pod_percent.png"

TITLE_COUNT_RAW = "Cereri per pod (delay)"
TITLE_COUNT_NORMALIZED = "Cereri normalizate (delay)"
TITLE_PERCENT = "Distribuție cereri (delay)"
...
print("\nTotal request-uri reale per algoritm:")
print(algorithm_totals)

print(f"\nTarget normalizare: {target_total_requests:,.0f} requests")

print("\nFactori de scalare:")
print(scale_factor_by_algorithm)

print("\nSalvat:")
print("CSV long:", OUT_LONG_CSV)
print("CSV count raw:", OUT_WIDE_COUNT_CSV)
print("CSV count normalized:", OUT_WIDE_NORMALIZED_CSV)
print("CSV percent:", OUT_WIDE_PERCENT_CSV)
print("Grafic raw count:", OUT_CHART_COUNT_RAW)
print("Grafic normalized count:", OUT_CHART_COUNT_NORMALIZED)
print("Grafic percent:", OUT_CHART_PERCENT)

print("\nDate raw count:")
print(wide_count_df)

print("\nDate normalized count:")
