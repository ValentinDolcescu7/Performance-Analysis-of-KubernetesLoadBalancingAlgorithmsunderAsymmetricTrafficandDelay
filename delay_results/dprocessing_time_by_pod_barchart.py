...
DATA_DIR = Path(r"delay_processing_time_by_pod")
ALGORITHM_ORDER = ["RR", "WRR", "LC", "SED", "NQ"]

OUT_DIR = DATA_DIR / "results"
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUT_LONG_CSV = OUT_DIR / "delay_processing_time_by_pod_long.csv"
OUT_WIDE_MINUTES_CSV = OUT_DIR / "delay_processing_time_by_pod_wide_minutes.csv"
OUT_WIDE_PERCENT_CSV = OUT_DIR / "delay_processing_time_by_pod_wide_percent.csv"

OUT_CHART_MINUTES = OUT_DIR / "delay_processing_time_by_pod_all_algorithms_minutes.png"
OUT_CHART_PERCENT = OUT_DIR / "delay_processing_time_by_pod_all_algorithms_percent.png"

TITLE_MINUTES = "Timp per pod (delay)"
TITLE_PERCENT = "Distribuție timp (delay)"
