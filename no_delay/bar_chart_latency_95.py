...
CSV_PATH = Path(r"p95_graphs\latency_avg_aligned.csv")

OUT_IMAGE = Path(r"p95_graphs\p95_latency_bar_chart.png")
OUT_SUMMARY = Path(r"p95_graphs\p95_latency_summary_bar.csv")

TITLE = "Întârziere P95"
Y_LABEL = "Întârziere medie P95 (ms)"
...
summary.columns = ["planificator", "intarziere_medie_p95_ms"]
