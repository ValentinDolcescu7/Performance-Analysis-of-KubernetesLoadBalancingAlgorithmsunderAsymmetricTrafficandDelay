...
CSV_PATH = Path(r"p99_graphs\latency_avg99_aligned.csv")

OUT_IMAGE = Path(r"p99_graphs\p99_latency_bar_chart.png")
OUT_SUMMARY = Path(r"p99_graphs\p99_latency_summary_bar.csv")

TITLE = "Întârziere P99"
Y_LABEL = "Întârziere medie P99 (ms)"
...
summary.columns = ["planificator", "intarziere_medie_p99_ms"]
